...
// ../node_modules/.pnpm/@hono+node-server@1.19.14_hono@4.12.21/node_modules/@hono/node-server/dist/index.mjs
...
// ../node_modules/.pnpm/hono@4.12.21/node_modules/hono/dist/utils/mime.js
...
// ../node_modules/.pnpm/@hono+node-server@1.19.14_hono@4.12.21/node_modules/@hono/node-server/dist/serve-static.mjs
...
var { access, mkdtemp, readFile, rename, rm, writeFile } = fsPromises;
var DEFAULT_PORT = 6270;
var MAX_PORT = 6280;
var HOST = "127.0.0.1";
var CARTOGRAPH_JSON = "cartograph.json";
var INVARIANTS_MD = "cartograph-invariants.md";
var skillRoot = fileURLToPath(new URL("./", import.meta.url));
var uiRoot = path.join(skillRoot, "ui");
var projectRoot = await findProjectRoot();
var port = await choosePort();
var app = new Hono2();
...
function watchProjectRoot() {
  ...
  try {
    watch(projectRoot, (eventType, filename) => {
      if ((eventType === "change" || eventType === "rename") && filename === CARTOGRAPH_JSON) {
    ...
    console.warn(
      `Warning: unable to watch ${resolveInProjectRoot(CARTOGRAPH_JSON)}: ${error instanceof Error ? error.message : String(error)}`
    );
  }
}
...
function isInvariantSaveBody(value) {
  return typeof value === "object" && value !== null && "contents" in value && typeof value.contents === "string";
}
