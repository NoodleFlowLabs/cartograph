...
9. Tell the user: "Start the Cartograph UI from your project root with `pnpm --dir skills/cartograph/app install` once, then `pnpm --dir skills/cartograph/app start`." If invariants were verified, also print the invariant summary to the console (same format as the Standalone Verify flow).
